...
11. **Macro goals drive optimization, micro goals are a crutch** - основные цели оптимизации всегда отправка формы + звонок. Микроцели (время на сайте, клик по телефону, скачать планировку) - подпорка когда данных по макро мало, не "стандарт"
...
Предложить клиенту варианты и согласовать набор:
- Клик по номеру телефона (если нет колтрекинга)
...
- **Расширенный каталог микроцелей для недвижимости**: текущий список (клик по телефону, открытие чата, 60/120/180 сек, скачать планировку, клик "рассчитать ипотеку", просмотр раздела ипотеки/планировок, прокрутка) - базовый. Проработать полный каталог с пояснением "когда какую использовать"
...
- **Бренд-кластер: застройщик**: второй раунд ревью с Димой прерван на разборе ключей по застройщику ("некрасовка девелопмент квартиры" - "там не все"). Добить полный разбор: какие ключи по застройщику нужны и в каких вариантах написания
